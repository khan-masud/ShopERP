...
export const config = {
  matcher: ["/login", "/dashboard/:path*", "/products/:path*", "/stock/:path*", "/pos/:path*", "/customers/:path*", "/sales/:path*", "/reports/:path*", "/expenses/:path*", "/audit/:path*", "/users/:path*", "/permissions/:path*", "/api/:path*"],
};
